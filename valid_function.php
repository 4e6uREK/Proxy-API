...
function get_valids($valid_db)
{
    $http_proxies = mysqli_query($valid_db, "SELECT ipv4, port FROM `http`");
    $socks4_proxies = mysqli_query($valid_db, "SELECT ipv4, port FROM `socks4`");
    $socks5_proxies = mysqli_query($valid_db, "SELECT ipv4, port FROM `socks5`");
...
function get_valid($valid_db, $id)
{
    $http = mysqli_query($valid_db, "SELECT ipv4, port FROM `http` WHERE `id` = '$id'");
    $socks4 = mysqli_query($valid_db, "SELECT ipv4, port FROM `socks4` WHERE `id` = '$id'");
    $socks5 = mysqli_query($valid_db, "SELECT ipv4, port FROM `socks5` WHERE `id` = '$id'");
...
function get_http_valids($valid_db)
{
    $http_proxies = mysqli_query($valid_db, "SELECT ipv4, port FROM `http`");
...
function get_socks4_valids($valid_db)
{
    $socks4_proxies = mysqli_query($valid_db, "SELECT ipv4, port FROM `socks4`");
...
function get_socks5_valids($valid_db)
{
    $socks5_proxies = mysqli_query($valid_db, "SELECT ipv4, port FROM `socks5`");
...
function get_http_valid($valid_db, $id)
{
    $http_proxy = mysqli_query($valid_db, "SELECT ipv4, port FROM `http` WHERE `id` = '$id'");
...
function get_socks4_valid($valid_db, $id)
{
    $socks4_proxy = mysqli_query($valid_db, "SELECT ipv4, port FROM `socks4` WHERE `id` = '$id'");
...
function get_socks5_valid($valid_db, $id)
{
    $socks5_proxy = mysqli_query($valid_db, "SELECT ipv4, port FROM `socks5` WHERE `id` = '$id'");
